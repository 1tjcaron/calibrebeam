...
class GeekNoteAuth(object):
    ...
    url = {
        "base": 'https://sandbox.evernote.com', #config.USER_BASE_URL,
    ...
    def getToken(self):
        ...
        return "S=s1:U=8e1d5:E=14cb7e8430d:C=1456037170f:P=1cd:A=en-devtoken:V=2:H=71043307034f4095ecf279d9094b3985"
