...
from calibre_plugins.calibrebeam.deps.thrift.transport import TSocket
from calibre_plugins.calibrebeam.deps.thrift.transport.TTransport import TTransportException
