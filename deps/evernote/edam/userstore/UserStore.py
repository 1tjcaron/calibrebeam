...
class Iface(object):
  ...
  def authenticate(self, username, password, consumerKey, consumerSecret, supportsTwoFactor):
    ...
    @param consumerKey
      ...
      by calibre_plugins.calibrebeam.deps.evernote.
...
class getUser_result(object):
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (calibre_plugins.calibrebeam.deps.evernote.edam.type.ttypes.User, calibre_plugins.calibrebeam.deps.evernote.edam.type.ttypes.User.thrift_spec), None, ), # 0
    (1, TType.STRUCT, 'userException', (calibre_plugins.calibrebeam.deps.evernote.edam.error.ttypes.EDAMUserException, calibre_plugins.calibrebeam.deps.evernote.edam.error.ttypes.EDAMUserException.thrift_spec), None, ), # 1
    (2, TType.STRUCT, 'systemException', (calibre_plugins.calibrebeam.deps.evernote.edam.error.ttypes.EDAMSystemException, calibre_plugins.calibrebeam.deps.evernote.edam.error.ttypes.EDAMSystemException.thrift_spec), None, ), # 2
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 0:
        if ftype == TType.STRUCT:
          self.success = calibre_plugins.calibrebeam.deps.evernote.edam.type.ttypes.User()
          self.success.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 1:
...
class getPublicUserInfo_result(object):
  ...
  thrift_spec = (
    ...
    (1, TType.STRUCT, 'notFoundException', (calibre_plugins.calibrebeam.deps.evernote.edam.error.ttypes.EDAMNotFoundException, calibre_plugins.calibrebeam.deps.evernote.edam.error.ttypes.EDAMNotFoundException.thrift_spec), None, ), # 1
    (2, TType.STRUCT, 'systemException', (calibre_plugins.calibrebeam.deps.evernote.edam.error.ttypes.EDAMSystemException, calibre_plugins.calibrebeam.deps.evernote.edam.error.ttypes.EDAMSystemException.thrift_spec), None, ), # 2
    (3, TType.STRUCT, 'userException', (calibre_plugins.calibrebeam.deps.evernote.edam.error.ttypes.EDAMUserException, calibre_plugins.calibrebeam.deps.evernote.edam.error.ttypes.EDAMUserException.thrift_spec), None, ), # 3
  )
...
class getPremiumInfo_result(object):
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (calibre_plugins.calibrebeam.deps.evernote.edam.type.ttypes.PremiumInfo, calibre_plugins.calibrebeam.deps.evernote.edam.type.ttypes.PremiumInfo.thrift_spec), None, ), # 0
    (1, TType.STRUCT, 'userException', (calibre_plugins.calibrebeam.deps.evernote.edam.error.ttypes.EDAMUserException, calibre_plugins.calibrebeam.deps.evernote.edam.error.ttypes.EDAMUserException.thrift_spec), None, ), # 1
    (2, TType.STRUCT, 'systemException', (calibre_plugins.calibrebeam.deps.evernote.edam.error.ttypes.EDAMSystemException, calibre_plugins.calibrebeam.deps.evernote.edam.error.ttypes.EDAMSystemException.thrift_spec), None, ), # 2
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 0:
        if ftype == TType.STRUCT:
          self.success = calibre_plugins.calibrebeam.deps.evernote.edam.type.ttypes.PremiumInfo()
          self.success.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 1:
