...
class AuthenticationResult(object):
  ...
  thrift_spec = (
    ...
    (4, TType.STRUCT, 'user', (calibre_plugins.interface_demo.deps.evernote.edam.type.ttypes.User, calibre_plugins.interface_demo.deps.evernote.edam.type.ttypes.User.thrift_spec), None, ), # 4
