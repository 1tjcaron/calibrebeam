...
class AuthenticationResult(object):
  ...
  thrift_spec = (
    ...
    (4, TType.STRUCT, 'user', (calibre_plugins.everlit.deps.evernote.edam.type.ttypes.User, calibre_plugins.everlit.deps.evernote.edam.type.ttypes.User.thrift_spec), None, ), # 4
