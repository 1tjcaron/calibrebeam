...
import calibre_plugins.read_once.deps.evernote.edam.userstore.ttypes
...
import calibre_plugins.read_once.deps.evernote.edam.limits.ttypes
...
class SyncChunk(object):
  ...
  thrift_spec = (
    ...
    (3, TType.I32, 'updateCount', None, None, ), # 3
    (4, TType.LIST, 'notes', (TType.STRUCT,(calibre_plugins.read_once.deps.evernote.edam.type.ttypes.Note, calibre_plugins.read_once.deps.evernote.edam.type.ttypes.Note.thrift_spec)), None, ), # 4
    (5, TType.LIST, 'notebooks', (TType.STRUCT,(calibre_plugins.read_once.deps.evernote.edam.type.ttypes.Notebook, calibre_plugins.read_once.deps.evernote.edam.type.ttypes.Notebook.thrift_spec)), None, ), # 5
    (6, TType.LIST, 'tags', (TType.STRUCT,(calibre_plugins.read_once.deps.evernote.edam.type.ttypes.Tag, calibre_plugins.read_once.deps.evernote.edam.type.ttypes.Tag.thrift_spec)), None, ), # 6
    (7, TType.LIST, 'searches', (TType.STRUCT,(calibre_plugins.read_once.deps.evernote.edam.type.ttypes.SavedSearch, calibre_plugins.read_once.deps.evernote.edam.type.ttypes.SavedSearch.thrift_spec)), None, ), # 7
    (8, TType.LIST, 'resources', (TType.STRUCT,(calibre_plugins.read_once.deps.evernote.edam.type.ttypes.Resource, calibre_plugins.read_once.deps.evernote.edam.type.ttypes.Resource.thrift_spec)), None, ), # 8
    ...
    (13, TType.LIST, 'linkedNotebooks', (TType.STRUCT,(calibre_plugins.read_once.deps.evernote.edam.type.ttypes.LinkedNotebook, calibre_plugins.read_once.deps.evernote.edam.type.ttypes.LinkedNotebook.thrift_spec)), None, ), # 13
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i4 in xrange(_size0):
            _elem5 = calibre_plugins.read_once.deps.evernote.edam.type.ttypes.Note()
            _elem5.read(iprot)
        ...
        if ftype == TType.LIST:
          ...
          for _i10 in xrange(_size6):
            _elem11 = calibre_plugins.read_once.deps.evernote.edam.type.ttypes.Notebook()
            _elem11.read(iprot)
        ...
        if ftype == TType.LIST:
          ...
          for _i16 in xrange(_size12):
            _elem17 = calibre_plugins.read_once.deps.evernote.edam.type.ttypes.Tag()
            _elem17.read(iprot)
        ...
        if ftype == TType.LIST:
          ...
          for _i22 in xrange(_size18):
            _elem23 = calibre_plugins.read_once.deps.evernote.edam.type.ttypes.SavedSearch()
            _elem23.read(iprot)
        ...
        if ftype == TType.LIST:
          ...
          for _i28 in xrange(_size24):
            _elem29 = calibre_plugins.read_once.deps.evernote.edam.type.ttypes.Resource()
            _elem29.read(iprot)
        ...
        if ftype == TType.LIST:
          ...
          for _i58 in xrange(_size54):
            _elem59 = calibre_plugins.read_once.deps.evernote.edam.type.ttypes.LinkedNotebook()
            _elem59.read(iprot)
...
class NoteList(object):
  ...
  thrift_spec = (
    ...
    (3, TType.LIST, 'notes', (TType.STRUCT,(calibre_plugins.read_once.deps.evernote.edam.type.ttypes.Note, calibre_plugins.read_once.deps.evernote.edam.type.ttypes.Note.thrift_spec)), None, ), # 3
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i88 in xrange(_size84):
            _elem89 = calibre_plugins.read_once.deps.evernote.edam.type.ttypes.Note()
            _elem89.read(iprot)
...
class NoteMetadata(object):
  ...
  thrift_spec = (
    ...
    None, # 13
    (14, TType.STRUCT, 'attributes', (calibre_plugins.read_once.deps.evernote.edam.type.ttypes.NoteAttributes, calibre_plugins.read_once.deps.evernote.edam.type.ttypes.NoteAttributes.thrift_spec), None, ), # 14
    None, # 15
    None, # 16
    None, # 17
    None, # 18
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRUCT:
          self.attributes = calibre_plugins.read_once.deps.evernote.edam.type.ttypes.NoteAttributes()
...
class RelatedResult(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'notes', (TType.STRUCT,(calibre_plugins.read_once.deps.evernote.edam.type.ttypes.Note, calibre_plugins.read_once.deps.evernote.edam.type.ttypes.Note.thrift_spec)), None, ), # 1
    (2, TType.LIST, 'notebooks', (TType.STRUCT,(calibre_plugins.read_once.deps.evernote.edam.type.ttypes.Notebook, calibre_plugins.read_once.deps.evernote.edam.type.ttypes.Notebook.thrift_spec)), None, ), # 2
    (3, TType.LIST, 'tags', (TType.STRUCT,(calibre_plugins.read_once.deps.evernote.edam.type.ttypes.Tag, calibre_plugins.read_once.deps.evernote.edam.type.ttypes.Tag.thrift_spec)), None, ), # 3
    (4, TType.LIST, 'containingNotebooks', (TType.STRUCT,(calibre_plugins.read_once.deps.evernote.edam.type.ttypes.NotebookDescriptor, calibre_plugins.read_once.deps.evernote.edam.type.ttypes.NotebookDescriptor.thrift_spec)), None, ), # 4
  )
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i169 in xrange(_size165):
            _elem170 = calibre_plugins.read_once.deps.evernote.edam.type.ttypes.Note()
            _elem170.read(iprot)
        ...
        if ftype == TType.LIST:
          ...
          for _i175 in xrange(_size171):
            _elem176 = calibre_plugins.read_once.deps.evernote.edam.type.ttypes.Notebook()
            _elem176.read(iprot)
        ...
        if ftype == TType.LIST:
          ...
          for _i181 in xrange(_size177):
            _elem182 = calibre_plugins.read_once.deps.evernote.edam.type.ttypes.Tag()
            _elem182.read(iprot)
        ...
        if ftype == TType.LIST:
          ...
          for _i187 in xrange(_size183):
            _elem188 = calibre_plugins.read_once.deps.evernote.edam.type.ttypes.NotebookDescriptor()
            _elem188.read(iprot)
